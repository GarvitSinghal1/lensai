...
- **SUBJECT MUST BE CENTERED**: Ensure main subject is in the middle 60% of the frame to avoid crop.
...
- Always specify "photorealistic, 9:16 vertical format, cinematic, centered composition" in prompts"""
